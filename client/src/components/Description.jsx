  ...
  return (
    ...
    >
      ...
      <div className='flex flex-col gap-5 md:gap-14 md:flex-row items-center'>
        ...
        <div>
            <h2 className='text-3xl font-medium max-w-lg mb-4'>Introducing the AI-Powerd Text to Image Generator</h2>
            <p className='text-gray-600 mb-4'>
                ...
                Imagine it, describe it, and watch come to life instantly.
            </p>
            <p className='text-gray-600'>
                ...
                effortlessly. Powerded by advanced AI technology, the creative possibilities are limitless!
            </p>
        </div>
      </div>
    </motion.div>
